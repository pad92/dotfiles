...
Most of this is from the [Arch Wiki](<https://wiki.archlinux.org/index.php/Dm-crypt/Encrypting_an_entire_system#Encrypted_boot_partition_(GRUB)>) and other resources linked thereof.
