...
# Récupère le chemin absolu du script et remplace l'extension par .yml
SCRIPT_PATH = os.path.abspath(__file__)
CONFIG_FILE = os.path.splitext(SCRIPT_PATH)[0] + ".yml"
...
def main():
    ...
    print(f"--- Sync : Lidarr[{args.tag}] -> Plex[{args.collection}] ---")
    print(f"Configuration utilisée : {os.path.basename(CONFIG_FILE)}")
